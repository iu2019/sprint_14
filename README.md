...
ИУ: исправил. Запретил паролю состоять из всех одинаковых символов (чуть строже, чем в замечании). Конечно, по-настоящему надо было бы требовать буквы обоих сортов,цифры и знаки...
